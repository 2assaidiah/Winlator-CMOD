...
public class EnvVarsView extends FrameLayout {
    public static final String[][] knownEnvVars = {
        ...
        {"DXVK_HUD", "SELECT_MULTIPLE", "devinfo", "fps", "frametimes", "submissions", "drawcalls", "pipelines", "descriptors", "memory", "gpuload", "version", "api", "cs", "compiler", "samplers", "scale=1.4", "scale=1.2", "scale=0.8", "scale=0.6", "opacity=0.8", "opacity=0.6", "opacity=0.4", "opacity=0.2", "opacity=0.1"},
