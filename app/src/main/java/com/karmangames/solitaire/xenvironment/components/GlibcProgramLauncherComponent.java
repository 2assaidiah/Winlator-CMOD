...
//        String[] command = {
//                "/data/user/0/com.karmangames.solitaire/files/imagefs/usr/lib/ld-linux-aarch64.so.1",
//                "--library-path", "/data/user/0/com.karmangames.solitaire/files/imagefs/usr/lib",
//                "/data/user/0/com.karmangames.solitaire/files/imagefs/usr/bin/vk_instance_debugger", "--help"
//        };
//
//
...
//    }
    ...
    private int execGuestProgram() {
        ...
        envVars.put("XAUTHORITY","/data/user/0/com.karmangames.solitaire/files/imagefs/home/xuser/.Xauthority");
...
//        String box64Version = preferences.getString("box64_version", DefaultVersion.BOX64);
    ...
    private void checkXServerConnectionUnixSocket() {
        File xSocket = new File("/data/data/com.karmangames.solitaire/files/imagefs/tmp/.X11-unix/X0");
        if (xSocket.exists()) {
