package com.karmangames.solitaire.container;

import android.os.Environment;
import android.util.Log;

import com.karmangames.solitaire.XrActivity;
...
public class Container {
    ...
    public static final String DEFAULT_DRIVES = "D:"+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+"E:/data/data/com.karmangames.solitaire/storage";
