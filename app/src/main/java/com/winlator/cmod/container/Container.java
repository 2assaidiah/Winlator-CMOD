...
public class Container {
    ...
    // Optimized defaults for Realme GT Master Edition (SD778G / Adreno 642L)
    public static final String DEFAULT_ENV_VARS = "WRAPPER_MAX_IMAGE_COUNT=0 ZINK_DESCRIPTORS=lazy ZINK_DEBUG=compact MESA_SHADER_CACHE_DISABLE=false MESA_SHADER_CACHE_MAX_SIZE=512MB mesa_glthread=true WINEESYNC=1 TU_DEBUG=noconform,sysmem DXVK_HUD=fps DXVK_STATE_CACHE=1";
    // 960x540 for better FPS on mid-range Adreno 642L
    public static final String DEFAULT_SCREEN_SIZE = "960x540";
    public static final String DEFAULT_GRAPHICS_DRIVER = "wrapper";
    public static final String DEFAULT_AUDIO_DRIVER = "alsa";
    // Box64 DynaRec is more mature for Cortex-A78 (SD778G)
    public static final String DEFAULT_EMULATOR = "Box64";
    // dxvk only - VKD3D is unstable on Adreno 6xx
    ...
    // Vulkan 1.1 is safer than 1.3 for Adreno 642L
    public static final String DEFAULT_GRAPHICSDRIVERCONFIG =
            "vulkanVersion=1.1" + ";version=" + ";blacklistedExtensions=" + ";maxDeviceMemory=0" + ";presentMode=mailbox" + ";syncFrame=0" + ";disablePresentWait=0" + ";resourceType=auto" + ";bcnEmulation=auto" + ";bcnEmulationType=compute" + ";bcnEmulationCache=0" + ";gpuName=Device";
